...
import com.humanizar.programaatendimento.application.outbound.mapper.OutboundUpdateMapper;
...
public class UpdateOutboxCommandUseCase {
    ...
    private final OutboundUpdateMapper outboundUpdateMapper;
    private final ObjectMapper objectMapper;

    public UpdateOutboxCommandUseCase(
            OutboxEventPort outboxEventPort,
            OutboundUpdateMapper outboundUpdateMapper,
            ObjectMapper objectMapper) {
        this.outboxEventPort = outboxEventPort;
        this.outboundUpdateMapper = outboundUpdateMapper;
    ...
    public void execute(
        ...
        OutboundEnvelopeDTO<List<ProgramaCommandDTO>> outboundEnvelope = outboundUpdateMapper
                .toUpdateCommandEnvelope(inboundEnvelope, eventId, aggregateId, commandPayload);
        ...
        OutboxEvent event = OutboxEvent.builder()
                ...
                .routingKey(RoutingKeyCatalog.PROGRAMA_UPDATED_V1)
