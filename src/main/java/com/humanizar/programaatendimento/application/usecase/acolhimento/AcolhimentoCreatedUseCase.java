...
public class AcolhimentoCreatedUseCase {
    ...
    private static final Logger log = LoggerFactory.getLogger(AcolhimentoCreatedUseCase.class);
    ...
    public EventOutcome execute(
        ...
        try {
            ...
            log.info(
                    "DataIntegrityViolation no processamento de criação -- possível duplicata. consumer={}, eventId={}",
